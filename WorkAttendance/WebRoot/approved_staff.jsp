...
　　　　									<td><s:property value="content"/></td> 
										<td>
										<s:if test="%{#apply.state==0}">未审核</s:if>
										<s:elseif test="%{#apply.state==1}">部门经理审核通过</s:elseif>
										<s:elseif test="%{#apply.state==2}">审核未通过</s:elseif>
										<s:elseif test="%{#apply.state==3}">管理员已更新考勤</s:elseif>
