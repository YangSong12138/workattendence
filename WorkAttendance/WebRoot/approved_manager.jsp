...
<body style="">
	<div class="wrapper">
		...
		<div class="container workspace">
			...
			<h3 style="padding:0 40px 0px;">请假/出差/补签申请审批</h3>	
...
　　　　									<td><s:property value="content"/></td> 
                                        <td><a href = "approveAction?id=<s:property value="id"/>&state=1"  onclick="javascript:return is_confirm()">通过</a>/<a href = "approveAction?id=<s:property value="id"/>&state=2"  onclick="javascript:return is_confirm()">驳回</a></td>
                                </tr>
                            </s:iterator >
					</table> 					
				</div>
